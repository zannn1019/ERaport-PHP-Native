...
<body>
    <div id="mySidenav" class="sidenav">
        <div class="link">
            ...
            <div class="dropdown" id="user">
                <ul>
                    <li><a href="./" class="d-list">Siswa</a></li>
    ...
    <div class="content">
        <div id="main">
            <div class="head">
                <div class="col-div-6">
                    <span class="nav">Data Siswa</span>
                </div>
                <div class="search">
            ...
            <?php
            $limit = 10;
            $sql = "SELECT *  FROM siswa  INNER JOIN kelas ON siswa.id_kelas = kelas.id_kelas INNER JOIN jurusan ON kelas.id_jurusan = jurusan.id_jurusan LIMIT $limit";
            $query_total = "SELECT COUNT(*) AS total_data FROM siswa";
            ...
            $offset = ($page - 1) * $limit;
            $no = 1;
            $query_page = "SELECT *  FROM siswa INNER JOIN kelas ON siswa.id_kelas = kelas.id_kelas INNER JOIN jurusan ON kelas.id_jurusan = jurusan.id_jurusan ORDER BY id_siswa ASC LIMIT $limit OFFSET $offset ";
                            ...
                            <table>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $s['nis'] ?></td>
                                        <td><?= $s['nama'] ?></td>
                                        <td><?= $s['id_kelas'] == ' ' ? 'Lulus' : $s['tingkatan'] . " " .  $s['jurusan'] . " " .  $s['nama_kelas'] ?>
                                        </td>
                                        <td><?= $s['status'] ?></td>
                                        <td>
                                            <div class="aksi-field">
                                                <a href="../detail/index.php?data=siswa&nis=<?= $s['nis'] ?>" class="detail-btn"><i class='bx bxs-user-detail'></i></a>
                                                <a href="../aksi/edit.php?data=siswa&nis=<?= $s['nis'] ?>" class="edit-btn"><i class='bx bxs-edit'></i></a>
                                                <a href="../aksi/hapus_siswa.php?id=<?= $s['id_siswa'] ?>" class="delete-btn" onclick="return confirm('Anda yakin untuk menghapus?')"><i class='bx bxs-trash'></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
                        ...
                        <div class="parent-tambah">
                            <form action="../aksi/tambah.php" method="post" enctype="multipart/form-data" class="form-user">
                                ...
                                <div class="form-tambah">
                                    ...
                                    <span>NIS</span>
                                    <span>:</span>
                                    <input type="text" name="nis" pattern="[0-9]+" minlength="9" maxlength="15" placeholder="Masukkan NIS" required>
                                    <span>Gmail</span>
                                    <span>:</span>
                                    <input type="email" name="email" minlength="8" placeholder="Masukkan Email" required>
                                    <span>Password</span>
                                    <span>:</span>
                                    ...
                                    <span>Nama Ortu</span>
                                    <span>:</span>
                                    <input type="text" name="nama_ortu" id="" placeholder="Masukkan nama Orang tua" required>
                                    <span></span>
                                    <span></span>
                                    <input type="submit" value="Tambah Siswa" class="submit-btn" name="tambah-siswa">
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="import-popup">
            ...
            <form action="../aksi/import.php" method="post" class="import-form" enctype="multipart/form-data">
                <a href="../../../asset/excel/example_import_siswa.xlsx">Donwload Templates Excel</a>
                <div class="container">
                    <div class="header">
                ...
                <input type="submit" value="Import data" name="import-siswa">
            </form>
        </div>
            ...
            $(document).ready(function() {
                ...
                $("#checkbox").change(function() {
                    if ($(this).is(":checked")) {
                        ...
                        $("#import-ico").attr('stroke', "#fff")
                    } else {
                        $("body").removeClass("dark-mode");
                        localStorage.setItem("mode", "light");
                        $("#import-ico").attr('stroke', "#000000")
                    }
                });
