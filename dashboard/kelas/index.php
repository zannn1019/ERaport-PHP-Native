...
<body>
    ...
    <div class="content">
        <div id="main">
            ...
            <?php
            $limit = 10;
            $query_total = "SELECT COUNT(*) AS total_data FROM kelas";
            ...
            $offset = ($page - 1) * $limit;
            $no = 1;
            $query_page = "SELECT * FROM kelas INNER JOIN jurusan ON kelas.id_jurusan = jurusan.id_jurusan LEFT JOIN guru ON kelas.wali_kelas = guru.id_guru ORDER BY id_kelas DESC LIMIT $limit OFFSET $offset";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="aksi-field">
                                                <a href="./detail.php?id=<?= $k['id_kelas'] ?>" class="detail-btn"><i class='bx bxs-user-detail'></i></a>
                                                <a href="../aksi/edit.php?edit=kelas&id=<?= $id_kelas ?>" class="edit-btn"><i class='bx bxs-edit'></i></a>
                                                <a href="../aksi/delete_kelas.php?id=<?= $k['id_kelas'] ?>" class="delete-btn" onclick="return confirm('Anda yakin untuk menghapus?')"><i class='bx bxs-trash'></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
            ...
            <div class="add-popup">
                ...
                <div class="parent-tambah">
                    <form action="../aksi/tambah_kelas.php" method="post" class="tambah-mapel">
                        <h1>Tambah Kelas</h1>
                        <div class="form-tambah">
                            <span>Tingkat</span>
                            <span>:</span>
                            <select name="tingkat" id="" required>
                            ...
                            <span>:</span>
                            <input type="search" id="wali_kelas" name="walas">
                            <span></span>
                            <span></span>
                            <div class="walas">
                                <div id="walas-result">
                        ...
                        <input type="submit" value="Tambah Kelas" class="submit-btn" name="tambah-kelas">
                    </form>
                </div>
            </div>
        </div>
