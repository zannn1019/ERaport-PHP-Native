...
<body>
    <div id="mySidenav" class="sidenav">
        <div class="link">
            ...
            <a href="./" class="icon-a <?= $role != 1 ? 'hidden' : '' ?> active"><i class="fa fa-list icons">&nbsp;&nbsp;</i><b class="link_nama ">Mapel</b></a>
    ...
    <div class="content">
        <div id="main">
            <div class="head">
                <div class="col-div-6">
                    <span class="nav">Data Mapel</span>
                </div>
                <div class="search">
            ...
            <?php
            $limit = 10;
            $query_total = "SELECT COUNT(*) AS total_data FROM mapel";
            ...
            $offset = ($page - 1) * $limit;
            $no = 1;
            $query_page = "SELECT * FROM mapel ORDER BY id_mapel DESC LIMIT $limit OFFSET $offset";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="aksi-field">
                                                <a href="../aksi/edit.php?edit=mapel&id=<?= $m['id_mapel'] ?>" class="edit-btn"><i class='bx bxs-edit'></i></a>
                                                <a href="../aksi/delete_mapel.php?id=<?= $m['id_mapel'] ?>" class="delete-btn" onclick="return confirm('Anda yakin untuk menghapus?')"><i class='bx bxs-trash'></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
    ...
    <div class="add-popup">
        ...
        <div class="parent-tambah">
            <form action="../aksi/tambah_mapel.php" method="post" class="tambah-mapel">
                <h1>Tambah Mapel</h1>
                <div class="form-tambah">
                    ...
                    <span>:</span>
                    <select name="jenis-mapel" id="" required>
                        <option value="">Pilih Jenis</option>
                        <option value="1">Umum</option>
                        <option value="2">Kejuruan</option>
                    </select>
                </div>
                <input type="submit" value="Tambah Mapel" class="submit-btn" name="tambah-mapel">
            </form>
        </div>
    </div>
